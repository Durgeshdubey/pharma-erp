...
export class CategoryManagementComponent implements OnInit {
  ...
  token;
  id;
  CategoryDislayedColumns: string[] = [
    "Category-id",
    "Category-name",
  ...
  category_dataSource: MatTableDataSource<CategoryManagementComponent>;
  ...
  applyFilter(filterValue: string) {
    ...
    if (this.category_dataSource.paginator) {
              this.category_dataSource.paginator.firstPage();
    }
}

  addNewCategory(){
    const dialogRef = this.dialog.open(AddNewCategoryComponent ,{width: "70%",height: "86vh",panelClass: 'full-width-dialog'});
  }
