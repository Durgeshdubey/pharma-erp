...
export class UserProfileComponent implements OnInit,OnDestroy {
  ...
  user_dataSource: MatTableDataSource<UserProfileComponent>;
  ...
  applyFilter(filterValue: string) {
    ...
    if (this.user_dataSource.paginator) {
              this.user_dataSource.paginator.firstPage();
    }
}

  addNewUser(){
    const dialogRef = this.dialog.open(UserDialogComponent ,{width: "70%",height: "86vh",panelClass: 'full-width-dialog'});
  }
